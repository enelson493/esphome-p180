  ...
  switch (event) {
    ...
    case ESP_GATTC_REG_FOR_NOTIFY_EVT: {
      ...
      if (descr != nullptr) {
        ...
        esp_ble_gattc_write_char_descr(this->parent_->gattc_if, this->parent_->conn_id, descr->handle,
...
void P180Component::send_status_request_() {
  ...
  esp_ble_gattc_write_char(this->parent_->gattc_if, this->parent_->conn_id, this->write_handle_, sizeof(cmd), cmd,
